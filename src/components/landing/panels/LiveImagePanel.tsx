...
// Interactions" đúng 2 cấp (không lồng thêm submenu): 4 mục Hover/Select/Won/Out of Stock giống hệt
// nhau, mỗi mục 1 <details> riêng (xem PrizeEffectPicker.tsx) — CẢ 4 dùng CHUNG đúng 1 khuôn
// Focus/Highlight/Motion/Appearance, không còn mục nào có nội dung RIÊNG nữa: "Spotlight" (từng gắn
// cứng CHỈ ở "Won" qua field `wonAmbientEffect` riêng) và "Dim" (từng là field nền
// `outOfStockDimAmount` CHỈ ở "Out of Stock") giờ đã gộp vào làm 2 lựa chọn bình thường của nhóm
// Highlight, chọn được ở CẢ 4 mục — xem doc-comment PrizeEffectName trong types.ts. Đã bỏ hẳn mục
// "Interact with Wheel" (dimUnselectedAmount) — không còn ai dùng.
