  ...
  return (
    <div className="space-y-3">
      ...
      <div>
        ...
        <p className="mt-1 text-[10px] leading-snug text-base-500">
          Applies to whichever text is showing right now — including the fallback text while still
          waiting. Pick "pulse" or "bounce" to keep it moving the whole time.
        </p>
      </div>
      ...
      <div>
        ...
        <p className="mt-1 text-[10px] leading-snug text-base-500">
          The swap itself — plays once, right at the moment the fallback text above is replaced by
          the real winner's name. "None" swaps instantly. Separate from Reveal effect above.
        </p>
      </div>
    </div>
  );
